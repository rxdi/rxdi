...
function parseSchemaDirectives(directives) {
    ...
    return graphql_1.parse(`{ a: String ${schemaDirectives.join(' ')} }`).definitions[0]['selectionSet'].selections[0].directives;
}
/**
...
exports.GraphQLCustomDirective = GraphQLCustomDirectivePrivate;
